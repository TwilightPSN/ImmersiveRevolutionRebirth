ServerEvents.recipes(IRRebirth => {
    ...
    IRRebirth.recipes.create.mixing('immersiveengineering:dust_coke', ['4x #forge:dusts/coal', Fluid.of("immersiveengineering:creosote", 1000)]).heated()
    IRRebirth.recipes.create.mixing('kubejs:raw_blast_brick', [Item.of('create:cinder_flour', 4), 'minecraft:clay', Fluid.water(100)]).superheated()
